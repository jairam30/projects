        ...
        <div class="right_col" role="main">
          <div class="x_content">
                   ...
                   <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="insertitem.php" method="post">
                      <span class="section">Add new Item</span>


                       <div class="item form-group">
                        <label id="itemname" class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Item Id <span class="required">*</span>
                        </label>
